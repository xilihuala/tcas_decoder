...
namespace UtilLib.CRC
{
    public class CRC32
    {
        ...
        public UInt32 SimpleCRC(Byte[] Data)
        {
            UInt32 crc = initReg;
            Int32 len = Data.Length;
            Int32 NumBitsPerRegShift = NumBytesPerRegShift * 8;
        ...
        public UInt32 IncrementalCRC(Byte[] Data)
        {
            UInt32 temp = initReg;
            initReg = currCRC ^ finalReg;
            CalculateCRC(Data);
            initReg = temp;
            return currCRC;
        }
        ...
        public UInt32 IncrementalCRC(Byte[] Data, int offset, int count)
        {
            UInt32 temp = initReg;
            initReg = currCRC ^ finalReg;
        ...
        public UInt32 IncrementalSimpleCRC(Byte[] Data)
        {
            UInt32 temp = initReg;
            initReg = currCRC;
            SimpleCRC(Data);
